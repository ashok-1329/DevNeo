...
@section('content')
    <div class="card-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 bg-secondary rounded px-3 py-2">
            <div>
                <h4 class="mb-1 text-uppercase text-light">Add Material</h4>
            </div>
        ...
        <form action="{{ route('materials.store') }}" method="POST" id="matForm" novalidate>
            @csrf
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    {{-- <input type="text" name="project_id" id="projectSelect"
                        class="form-control @error('project_id') is-invalid @enderror" value="{{ old('project_id') }}"> --}}
