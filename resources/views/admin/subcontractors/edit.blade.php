...
<div class="card-container">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 bg-secondary rounded px-3 py-2">
        <div>
            <h4 class="mb-1 text-uppercase ls-1 text-light">Edit Diary Subcontractor</h4>
    ...
    <form action="{{ route('subcontractors.update', $diarySubcontractor->id) }}" method="POST"
          id="dsForm" novalidate>
        @csrf
        @method('PUT')

        @php
            $selectedBn  = $diarySubcontractor->businessName;
            $selectedWt  = $diarySubcontractor->workType;
            $bnIsOther   = $selectedBn && strtolower($selectedBn->name) === 'other';
            $wtIsOther   = $selectedWt && strtolower($selectedWt->name) === 'other';
        @endphp
        ...
        <div class="ds-form-body mb-4">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="business_name" id="businessNameSelect"
                        ...
                        @foreach ($businessNames as $bn)
                            <option value="{{ $bn->id }}"
                                ...
                                {{ old('business_name', $diarySubcontractor->business_name) == $bn->id ? 'selected' : '' }}>
                                {{ $bn->name }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div id="businessNameOtherWrap"
                         class="mt-2 {{ ($bnIsOther || old('business_name_other')) ? '' : 'd-none' }}">
                        <label class="form-label fw-semibold small text-uppercase">
                        ...
                        <input type="text" name="business_name_other" id="businessNameOther"
                            ...
                            value="{{ old('business_name_other', $diarySubcontractor->business_name_other) }}">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="rep_name" id="repName"
                        ...
                        value="{{ old('rep_name', $diarySubcontractor->rep_name) }}">
                    <div class="invalid-feedback">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="subcontractor_asset_id"
                        ...
                        value="{{ old('subcontractor_asset_id', $diarySubcontractor->subcontractor_asset_id) }}">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <select name="type_of_work" id="typeOfWorkSelect"
                        ...
                        @foreach ($workTypes as $wt)
                            <option value="{{ $wt->id }}"
                                ...
                                {{ old('type_of_work', $diarySubcontractor->type_of_work) == $wt->id ? 'selected' : '' }}>
                                {{ $wt->name }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div id="typeOfWorkOtherWrap"
                         class="mt-2 {{ ($wtIsOther || old('type_of_work_other')) ? '' : 'd-none' }}">
                        <label class="form-label fw-semibold small text-uppercase">
                        ...
                        <input type="text" name="type_of_work_other" id="typeOfWorkOther"
                            ...
                            value="{{ old('type_of_work_other', $diarySubcontractor->type_of_work_other) }}">
                        <div class="invalid-feedback">
