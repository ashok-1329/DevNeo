...
@section('content')
    <div class="card-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 pr-form-header rounded px-3 py-2 bg-secondary">
            <div>
                <h4 class="mb-1 text-uppercase ls-1 text-light">Add Payment Rule</h4>
        ...
        <form action="{{ route('payment-rules.store') }}" method="POST" id="paymentRuleForm" enctype="multipart/form-data"
            novalidate>
            @csrf
            ...
            <div class="pr-form-body mb-4">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <select name="supplier_name"
                            ...
                            @foreach ($suppliers as $s)
                                <option value="{{ $s->id }}" {{ old('supplier_name') == $s->id ? 'selected' : '' }}>
                                    {{ $s->supplier_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="payment_date" id="payment_date"
                            ...
                            placeholder="dd/mm/yyyy" value="{{ old('payment_date', formatToUserDate($today)) }}">
                        <div class="invalid-feedback">
                            @error('payment_date')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="frequency_payment_id"
                            ...
                            @foreach ($frequencyPayments as $fp)
                                <option value="{{ $fp->id }}"
                                    {{ old('frequency_payment_id') == $fp->id ? 'selected' : '' }}>
                                    {{ $fp->name }}
                                </option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                            @error('frequency_payment_id')
                                {{ $message }}
                            @enderror
                        </div>
                    </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="end_date" id="end_date"
                            class="form-control datepicker @error('end_date') is-invalid @enderror" placeholder="dd/mm/yyyy"
                            value="{{ old('end_date') }}">
                        <div class="invalid-feedback">
                            @error('end_date')
                                {{ $message }}
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group ">
                            ...
                            <input type="text" name="value_inc_gst"
                                class="form-control @error('value_inc_gst') is-invalid @enderror" placeholder="0.00"
                                value="{{ old('value_inc_gst') }}">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="project_number_select"
                            ...
                            @foreach ($projects as $proj)
                                <option value="{{ $proj->id }}" data-number="{{ $proj->project_number }}"
                                    data-code="{{ $proj->project_code_id ?? '' }}">
                                    {{ $proj->project_number }}
                                </option>
                            @endforeach
                        </select>
                        <input type="hidden" name="project_number" value="{{ old('project_number') }}">
                        <div class="invalid-feedback">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="project_code" id="project_code"
                            ...
                            placeholder="Auto-filled" value="{{ old('project_code') }}" readonly tabindex="-1">
                        <div class="invalid-feedback">
                            @error('project_code')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea name="payment_description" rows="4"
                            ...
                            placeholder="Enter payment description">{{ old('payment_description') }}</textarea>
                        <div class="invalid-feedback">
                ...
                {{-- ── Row 4: File Upload (document type) ── --}}
                <div class="row g-3">
                    <div class="col-12">
                        <label class="form-label fw-semibold small text-uppercase">
                            Upload Supporting Documents <span class="text-danger">*</span>
                        </label>
                        <x-dropzone name="document" type="document" id="documentInput" :required="true" />
                    </div>
                </div>
