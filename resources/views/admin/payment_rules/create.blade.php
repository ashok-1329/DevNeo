...
<div class="card-container">
    ...
    <form action="{{ route('payment-rules.store') }}" method="POST"
        ...
        <div class="pr-form-body mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <select name="supplier_name"
                        ...
                        @foreach ($suppliers as $s)
                            <option value="{{ $s->id }}"
                                {{ old('supplier_name') == $s->id ? 'selected' : '' }}>
                                {{ $s->supplier_name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    {{-- The select drives the hidden project_number and readonly project_code --}}
                    ...
                    {{-- Hidden inputs carry the actual stored values --}}
                        ...
                        <div id="dropZone" class="upload-drop-zone @error('document') border-danger @enderror">
                            ...
                            <div id="uploadPlaceholder" class="upload-placeholder">
                                ...
                                <p class="mb-1 text-secondary small fw-semibold">
                                    Drag &amp; drop file here, or <span class="text-success">click to browse</span>
                                </p>
...
<style>
    ...
    .upload-file-item i { display: block; }

    /* Hide placeholder once a preview renders */
