...
@section('content')
    <div class="card-container">
        ...
        <div class="d-flex justify-content-between mb-4 bg-secondary px-3 py-2 rounded">
            <h4 class="text-light mb-0 text-uppercase">Add Docket</h4>
        ...
        <form action="{{ route('dockets.store') }}" method="POST" id="docketForm" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="docket_number" id="docketNumber"
                        class="form-control @error('docket_number') is-invalid @enderror" value="{{ old('docket_number') }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="docket_date" id="docketDate"
                        class="form-control @error('docket_date') is-invalid @enderror" value="{{ old('docket_date') }}">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="job_code" id="jobCode"
                        class="form-control @error('job_code') is-invalid @enderror" value="{{ old('job_code') }}"
                ...
                <div class="col-md-6">
                    ...
                    <select name="sub_contractor" id="subContractorSelect"
                        ...
                        @foreach ($subcontractors as $sc)
                            <option value="{{ $sc->id }}" {{ old('sub_contractor') == $sc->id ? 'selected' : '' }}>
                                {{ $sc->business_name }}
                            </option>
                        @endforeach
                    </select>
