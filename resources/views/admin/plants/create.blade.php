...
@section('content')
    <div class="card-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 bg-secondary rounded px-3 py-2">
            <div>
                <h4 class="mb-1 text-uppercase text-light">Add Plant</h4>
            </div>
        ...
        <form action="{{ route('plant.store') }}" method="POST" id="plantForm" novalidate>
            @csrf
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="plant_type" id="plantTypeSelect"
                        ...
                        <option value="1" {{ old('plant_type') == '1' ? 'selected' : '' }}>Owned</option>
                        <option value="2" {{ old('plant_type') == '2' ? 'selected' : '' }}>Hired</option>
                    </select>
                    <div class="invalid-feedback">
                        @error('plant_type')
                            {{ $message }}
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="plant_name" id="plantNameInput"
                        class="form-control @error('plant_name') is-invalid @enderror" value="{{ old('plant_name') }}">
                    <div class="invalid-feedback">
                        @error('plant_name')
                            {{ $message }}
                        @enderror
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="plant_code" id="plantCodeInput"
                        class="form-control @error('plant_code') is-invalid @enderror" value="{{ old('plant_code') }}">
                    <div class="invalid-feedback">
                        @error('plant_code')
                            {{ $message }}
                        @enderror
            ...
            <div class="mb-3">
                ...
                <input type="radio" name="is_docket" value="1" {{ old('is_docket') == '1' ? 'checked' : '' }}> Yes

                <input type="radio" name="is_docket" value="0" {{ old('is_docket') == '0' ? 'checked' : '' }}> No
            ...
            <div class="mb-3">
                ...
                <input type="radio" name="add_to_diary" value="1" {{ old('add_to_diary') == '1' ? 'checked' : '' }}>
                Yes

                <input type="radio" name="add_to_diary" value="0" {{ old('add_to_diary') == '0' ? 'checked' : '' }}>
                No
