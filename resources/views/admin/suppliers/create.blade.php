...
@section('content')
    <div class="card-container">
        ...
        <form action="{{ route('suppliers.store') }}" method="POST" id="supplierForm" novalidate>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="payment_terms"
                            ...
                            @foreach ($paymentTerms as $pt)
                                <option value="{{ $pt }}" {{ old('payment_terms') == $pt ? 'selected' : '' }}>
                                    {{ $pt }}
                                </option>
                            @endforeach
                        </select>
            ...
            {{-- FIX: hidden input that carries Quill HTML to the server --}}
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // FIX: sync Quill HTML into hidden input right before the form submits
