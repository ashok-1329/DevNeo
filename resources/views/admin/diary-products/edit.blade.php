...
@section('content')
    <div class="card-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 bg-secondary rounded px-3 py-2">
            <div>
                <h4 class="mb-1 text-uppercase ls-1 text-light">Edit Dairy Product</h4>
            ...
            <div class="d-flex gap-2">
                {{-- <a href="{{ route('diary-products.show', $product->id) }}" class="btn btn-secondary btn-sm">
        ...
        <form action="{{ route('diary-products.update', $product->id) }}" method="POST" id="diaryProductForm" novalidate>
            @csrf
            @method('PUT')
